...
Revision ID: b45ad4f9f69c
Revises: c2fac8fb1ed2
Create Date: 2026-07-24 17:35:30.124449
...
revision: str = "b45ad4f9f69c"
down_revision: str | Sequence[str] | None = "c2fac8fb1ed2"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None


# procrastinate v3.9.x の schema.sql をそのままコピー.
# alembic に公式統合が無い (upstream #1040) ため, 初期スキーマは手動で取り込む.
# ライブラリを upgrade する時は procrastinate/sql/migrations/ の
# pre/post SQL を別 revision として追加する.
_UPGRADE_SQL = r"""
...
# schema.sql が作る全オブジェクトを削除する SQL.
# CASCADE で trigger, index, foreign key は table drop で連鎖削除される.
_DOWNGRADE_SQL = r"""
